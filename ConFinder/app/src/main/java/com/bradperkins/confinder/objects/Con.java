...
public class Con implements Serializable {
    ...
    public Con(String address, String building, String city, String date, String hours1,
               ...
               String url, double zip, double distance, int likes, String admin, int attending, String conid) {
