...
import com.bradperkins.confinder.fragments.ProfileFragment;
...
public class ProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, ProfileFragment.ProfileListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null){
            name = getIntent().getStringExtra("PROFILE_NEW_NAME");
            email = getIntent().getStringExtra("PROFILE_NEW_EMAIL");
        }
        ...
        getFragmentManager().beginTransaction().replace(R.id.profile_placeholder, ProfileFragment.newInstance(name, email)).commit();
...
//                startActivity(profileIntent);
    ...
    @Override
    public void conAlerts(boolean isNotify) {

        SharedPreferences notifyPref = getSharedPreferences("NOTIFY_PREF" ,this.MODE_PRIVATE);
        SharedPreferences.Editor editor = notifyPref.edit();
        editor.putBoolean("NOTIFY_PREF_BOOL", isNotify);
        editor.commit();
